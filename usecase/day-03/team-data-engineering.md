# 🧪 Lab J3 — Team DATA ENGINEERING · Amal · Lara
...
```hcl
# Je LIS le warehouse de Fares — je ne le crée pas, je ne le gère pas
data "snowflake_warehouses" "ingest" {
  like = "WH_APP01_INGEST_DEV"   # le warehouse de l'équipe Platform
}
```
