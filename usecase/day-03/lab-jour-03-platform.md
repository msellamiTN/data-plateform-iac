# 🧪 Lab J3 — Team PLATFORM · Mohamed · Sirine
...
**Problème :** au Jour 1, j'ai créé `WH_APP02_LEGACY` **à la main** dans Snowsight. Il existe dans Snowflake mais pas dans mon code. C'est une **ressource orpheline** — Terraform ne la connaît pas.
...
```powershell
terraform import snowflake_warehouse.legacy WH_APP02_LEGACY
```
