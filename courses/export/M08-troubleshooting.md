...
1. Vérifiez que vous êtes dans le bon répertoire :
   ...
   ```powershell
   pwd  # doit afficher labs/m08-environments/
   ```

2. Si vous êtes dans `environments/dev/`, vous êtes dans l'ancienne structure. Déplacez-vous vers `labs/m08-environments/`.
