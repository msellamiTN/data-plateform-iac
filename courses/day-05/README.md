...
**Aujourd'hui :** c'est le jour de la mise en production. Vous connectez Snowflake à un stockage externe (préparé par le formateur), passez du PAT à l'authentification RSA/JWT, définissez le RBAC as code, assemblez le capstone et prouvez le zero-drift.
...
flowchart LR
    ...
    M12 --> ANNEXES[Annexes M13/M14 optionnelles]
```
...
### Annexes optionnelles (hors parcours 3+2)

| Module | Dossier de travail | Lab | Cours |
|---|---|---|---|
| [M13 — FinOps & observabilité](module-13-finops-observability/lab.md) | `labs/m13-finops-observability/` | [lab](module-13-finops-observability/lab.md) | [cours](module-13-finops-observability/course.md) |
...
> M13 et M14 sont des **annexes facultatives**. Elles ne sont pas un critère de réussite du parcours 3+2. Elles peuvent être traitées après la formation ou en autonomie.
...
Plateforme Snowflake connectée, sécurisée par RSA/JWT, gouvernée par RBAC as code, validée par zero-drift et nettoyée. Capstone : soutenance avec preuves.
